...
class _InAppPurchaseScreenState extends State<InAppPurchaseScreen> {
  ...
  final List<String> _productLists = Platform.isAndroid ? ['t1_299_mn', 't2_599_mn', 't3_1199_mn'] : ['ts_299_mnA', 'ts_599_mna', 'ts_1199_mnA'];
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            ...
                            'The subscription includes covering any type of parking/traffic ticket. Monthly subscription includes the total tier price for the tier the end user subscribes too for one year. The end user must have the the subscription for one month before they can submit a claim. end user can cancel anytime.\nFeatures includedPaying end user parking/traffic ticketsKeeping track of any tickets on the end user account\nCancel anytime. Questions? ',
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          launchASURL(url: 'http://143.198.63.52/ticket_stopper/term_and_condition');
                        },
                        child: Text(
                      ...
                      GestureDetector(
                        onTap: () {
                          launchASURL(url: 'http://143.198.63.52/ticket_stopper/privacy-policy');
                        },
                        child: Text(
                          'Privacy Policy',
                          textAlign: TextAlign.center,
